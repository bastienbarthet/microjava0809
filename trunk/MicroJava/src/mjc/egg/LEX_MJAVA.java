...
public class LEX_MJAVA extends LEXICAL4  {
 ...
 public static final int token_this = 10 ;
 public static final int token_import = 11 ;
 public static final int token_ident = 12 ;
 public static final int token_div = 13 ;
 public static final int token_pv = 14 ;
 public static final int token_vrai = 15 ;
 public static final int token_pt = 16 ;
 public static final int token_int = 17 ;
 public static final int token_nouveau = 18 ;
 public static final int token_aco = 19 ;
 public static final int token_inf = 20 ;
 public static final int token_acf = 21 ;
 public static final int token_ou = 22 ;
 public static final int token_static = 23 ;
 public static final int token_etend = 24 ;
 public static final int token_bool = 25 ;
 public static final int token_moins = 26 ;
 public static final int token_neg = 27 ;
 public static final int token_tantque = 28 ;
 public static final int token_affect = 29 ;
 public static final int token_retour = 30 ;
 public static final int token_virg = 31 ;
 public static final int token_entier = 32 ;
 ...
 public static final int token_prive = 43 ;
